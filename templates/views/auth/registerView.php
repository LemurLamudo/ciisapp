    ...
    <div>
      <div class="row vh-100">
        ...
        <div class="col-md-12 bg-gradient-blue">
          ...
          <div class="row align-items-center justify-content-center bg-white mx-auto py-5" style="width: 500px;border-radius:8px;">
            <div class="col-md-10">
              ...
              <div class="mt-5">
                  <form class="bee_add_new_usuario">
                      <div>
                          ...
                          <input class="form-input py-4 px-5" type="email" name="email" id="email" value="<?php echo $email ?>" disabled>
                      </div>
                      <div>
                          <div class="font-bold form-label mt-4">Nombres y Apellidos</div>
                          <input class="form-input py-4 px-5" name="name" id="name" type="text">
                      </div>
                      <div>
                          <div class="font-bold form-label mt-4">Tipo Documento</div>
                          <select class="form-input py-4 px-5" name="tipo_doc" id="tipo_doc">
                      ...
                      <div>
                          ...
                          <input class="form-input py-4 px-5" type="number" name="number" id="number">
                      </div>
