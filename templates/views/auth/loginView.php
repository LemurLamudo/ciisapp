...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <meta name="description" content="El Congreso Internacional de Informática y Sistemas (CIIS) brinda toda una gama de conocimiento con respecto a distintos temas de la informática con ponentes del más alto nivel">
    <meta property="og:title" content="XXII Congreso Internacional de Informática y Sistemas">
    <meta property="og:type" content="website">
    <meta property="og:description" content="El Congreso Internacional de Informática y Sistemas (CIIS) brinda todo una gama de conocimiento con respecto a distintos temas de la informática con ponentes del más alto nivel">
    ...
    <link rel="icon" href="<?php echo FAVICON.'favicon-192x192.png' ?>" type="image/png" sizes="192x192">
	...
	<main>
		<div>
			<div class="row vh-100">
				...
				<div class="col-md-12 bg-gradient-blue">
          <div class="d-flex py-4 justify-content-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 349 106.7" width="160" height="90" fill="#fff" class="logo-white">
          ...
          <div class="row align-items-center justify-content-center bg-white mx-auto py-7" style="width: 500px;border-radius:8px;">
            <div class="col-md-10">
                  ...
                  <form>
                      ...
                      <div class="mt-4">
                          <div class="flex justify-between items-center">
                              <div class="font-bold form-label">
                                  Contraseña
                              </div>
                          </div>
                        ...
                        <div class="form-foot">
                          <label class="checkbox" for="rec">
                              ...
                              <div class="rec-box"></div><span>Recordarme</span>
                          </label>
