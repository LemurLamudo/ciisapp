                ...
                $data.data.forEach(ponente => {
                    if(ponente.status_ponencia == 1){
                        ...
                        <div class="col-12 mb-4 mb-md-0" style="opacity:0.5"> 
                            ...
                            if(aux) htmlOptions += `<div class="col-md-2 d-flex justify-content-center align-items-center"><a href="#" class="btn btn-success">Asistencia</a></div>`;
                            else  htmlOptions += `<div class="col-md-2 d-flex justify-content-center align-items-center"><a href="#" class="btn btn-danger">Falta</a></div>`;   
